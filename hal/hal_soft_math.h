...
void hal_matrix_vmul_tiled_i32(int64_t *c, const int32_t *a, const int32_t *b, int M, int N, int K,
                               int tile_size);
void hal_matrix_vmul_tiled_i64(int128_t *c, const int64_t *a, const int64_t *b, int M, int N, int K,
                               int tile_size);
...
void hal_matrix_vmul_tiled_u64(uint128_t *c, const uint64_t *a, const uint64_t *b, int M, int N,
                               int K, int tile_size);
void hal_matrix_vmul_tiled_u128(uint256_t *c, const uint128_t *a, const uint128_t *b, int M, int N,
                                int K, int tile_size);
