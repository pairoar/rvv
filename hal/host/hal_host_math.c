...
// -----------------------------------------------------------------------------
// single-width multiplicaton
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS2(vmul, i8, MUL, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS2(vmul, i16, MUL, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS2(vmul, i32, MUL, int32_t, int32_t)
DEFINE_HAL_GENERAL_OPS2(vmul, i64, MUL, int64_t, int64_t)

DEFINE_HAL_GENERAL_OPS2(vmul, u8, MUL, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS2(vmul, u16, MUL, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS2(vmul, u32, MUL, uint32_t, uint32_t)
DEFINE_HAL_GENERAL_OPS2(vmul, u64, MUL, uint64_t, uint64_t)

// -----------------------------------------------------------------------------
// widening multiplicaton
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS2(vwmul, i8, MUL, int8_t, int16_t)
DEFINE_HAL_GENERAL_OPS2(vwmul, i16, MUL, int16_t, int32_t)
DEFINE_HAL_GENERAL_OPS2(vwmul, i32, MUL, int32_t, int64_t)
DEFINE_HAL_GENERAL_OPS2(vwmul, i64, hal_wmul_i64, int64_t, int128_t)

DEFINE_HAL_GENERAL_OPS2(vwmul, u8, MUL, uint8_t, uint16_t)
DEFINE_HAL_GENERAL_OPS2(vwmul, u16, MUL, uint16_t, uint32_t)
DEFINE_HAL_GENERAL_OPS2(vwmul, u32, MUL, uint32_t, uint64_t)
DEFINE_HAL_GENERAL_OPS2(vwmul, u64, hal_wmul_u64, uint64_t, uint128_t)


// -----------------------------------------------------------------------------
// multiplication not accumulation
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS4(vmac, i8, MUL, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS4(vmac, i16, MUL, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS4(vmac, i32, MUL, int32_t, int32_t)

DEFINE_HAL_GENERAL_OPS4(vmac, u8, MUL, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS4(vmac, u16, MUL, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS4(vmac, u32, MUL, uint32_t, uint32_t)

// -----------------------------------------------------------------------------
// widening multiplication not accumulation
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS4(vwmac, i8, MUL, int8_t, int16_t)
DEFINE_HAL_GENERAL_OPS4(vwmac, i16, MUL, int16_t, int32_t)
DEFINE_HAL_GENERAL_OPS4(vwmac, i32, MUL, int32_t, int64_t)

DEFINE_HAL_GENERAL_OPS4(vwmac, u8, MUL, uint8_t, uint16_t)
DEFINE_HAL_GENERAL_OPS4(vwmac, u16, MUL, uint16_t, uint32_t)
DEFINE_HAL_GENERAL_OPS4(vwmac, u32, MUL, uint32_t, uint64_t)
...
// wdot product
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS5(vwdot, i8, MUL, int8_t, int16_t)
DEFINE_HAL_GENERAL_OPS5(vwdot, i16, MUL, int16_t, int32_t)
DEFINE_HAL_GENERAL_OPS5(vwdot, i32, MUL, int32_t, int64_t)

DEFINE_HAL_GENERAL_OPS5(vwdot, u8, MUL, uint8_t, uint16_t)
DEFINE_HAL_GENERAL_OPS5(vwdot, u16, MUL, uint16_t, uint32_t)
DEFINE_HAL_GENERAL_OPS5(vwdot, u32, MUL, uint32_t, uint64_t)
...
// matrix multiplication
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS6(matrix_vmul, i8, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vmul, i16, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vmul, i32, int32_t, int32_t)

DEFINE_HAL_GENERAL_OPS6(matrix_vmul, u8, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vmul, u16, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vmul, u32, uint32_t, uint32_t)

// -----------------------------------------------------------------------------
// widening matrix multiplication
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, i8, int8_t, int16_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, i16, int16_t, int32_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, i32, int32_t, int64_t)

DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, u8, uint8_t, uint16_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, u16, uint16_t, uint32_t)
DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, u32, uint32_t, uint64_t)
...
DEFINE_HAL_GENERAL_OPS2(vmul, f32, MUL, float, float)
DEFINE_HAL_GENERAL_OPS4(vmac, f32, MUL, float, float)
DEFINE_HAL_GENERAL_OPS3(vdiv, f32, DIV, float, float)
DEFINE_HAL_GENERAL_OPS5(vdot, f32, MUL, float, float)
...
DEFINE_HAL_GENERAL_OPS6(matrix_vmul, f32, float, float)

DEFINE_HAL_GENERAL_OPS7(vwadd, f32, WADD, float, double)
DEFINE_HAL_GENERAL_OPS7(vwsub, f32, WSUB, float, double)
DEFINE_HAL_GENERAL_OPS2(vwmul, f32, MUL, float, double)
DEFINE_HAL_GENERAL_OPS4(vwmac, f32, MUL, float, double)
DEFINE_HAL_GENERAL_OPS5(vwdot, f32, MUL, float, double)
DEFINE_HAL_GENERAL_OPS6(matrix_vwmul, f32, float, double)
...
// and
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS3(vand, i8, AND, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS3(vand, i16, AND, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS3(vand, i32, AND, int32_t, int32_t)
DEFINE_HAL_GENERAL_OPS3(vand, i64, AND, int64_t, int64_t)

DEFINE_HAL_GENERAL_OPS3(vand, u8, AND, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS3(vand, u16, AND, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS3(vand, u32, AND, uint32_t, uint32_t)
DEFINE_HAL_GENERAL_OPS3(vand, u64, AND, uint64_t, uint64_t)

// -----------------------------------------------------------------------------
// or
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS3(vor, i8, OR, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS3(vor, i16, OR, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS3(vor, i32, OR, int32_t, int32_t)
DEFINE_HAL_GENERAL_OPS3(vor, i64, OR, int64_t, int64_t)

DEFINE_HAL_GENERAL_OPS3(vor, u8, OR, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS3(vor, u16, OR, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS3(vor, u32, OR, uint32_t, uint32_t)
DEFINE_HAL_GENERAL_OPS3(vor, u64, OR, uint64_t, uint64_t)

// -----------------------------------------------------------------------------
// xor
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS3(vxor, i8, XOR, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS3(vxor, i16, XOR, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS3(vxor, i32, XOR, int32_t, int32_t)
DEFINE_HAL_GENERAL_OPS3(vxor, i64, XOR, int64_t, int64_t)

DEFINE_HAL_GENERAL_OPS3(vxor, u8, XOR, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS3(vxor, u16, XOR, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS3(vxor, u32, XOR, uint32_t, uint32_t)
DEFINE_HAL_GENERAL_OPS3(vxor, u64, XOR, uint64_t, uint64_t)

// -----------------------------------------------------------------------------
// not
// -----------------------------------------------------------------------------
DEFINE_HAL_GENERAL_OPS1(vnot, i8, NOT, int8_t, int8_t)
DEFINE_HAL_GENERAL_OPS1(vnot, i16, NOT, int16_t, int16_t)
DEFINE_HAL_GENERAL_OPS1(vnot, i32, NOT, int32_t, int32_t)
DEFINE_HAL_GENERAL_OPS1(vnot, i64, NOT, int64_t, int64_t)

DEFINE_HAL_GENERAL_OPS1(vnot, u8, NOT, uint8_t, uint8_t)
DEFINE_HAL_GENERAL_OPS1(vnot, u16, NOT, uint16_t, uint16_t)
DEFINE_HAL_GENERAL_OPS1(vnot, u32, NOT, uint32_t, uint32_t)
DEFINE_HAL_GENERAL_OPS1(vnot, u64, NOT, uint64_t, uint64_t)
