...
hal_status_t hal_matrix_vmul_u8(uint16_t *c, const uint8_t *a, const uint8_t *b, int M, int N, int K);

/* i16/u16 */
hal_status_t hal_matrix_vmul_i16(int32_t *c, const int16_t *a, const int16_t *b, int M, int N, int K);
hal_status_t hal_matrix_vmul_u16(uint32_t *c, const uint16_t *a, const uint16_t *b, int M, int N, int K);

/* i32/u32 */
hal_status_t hal_matrix_vmul_i32(int64_t *c, const int32_t *a, const int32_t *b, int M, int N, int K);
hal_status_t hal_matrix_vmul_u32(uint64_t *c, const uint32_t *a, const uint32_t *b, int M, int N, int K);

/* i64/u64 */
hal_status_t hal_matrix_vmul_i64(int128_t *c, const int64_t *a, const int64_t *b, int M, int N, int K);
hal_status_t hal_matrix_vmul_u64(uint128_t *c, const uint64_t *a, const uint64_t *b, int M, int N, int K);

/* i128/u128 */
hal_status_t hal_matrix_vmul_i128(int256_t *c, const int128_t *a, const int128_t *b, int M, int N, int K);
hal_status_t hal_matrix_vmul_u128(uint256_t *c, const uint128_t *a, const uint128_t *b, int M, int N,
                          int K);
